    ...
    protected $fillable =[
        ...
        "name", "code", "type", "barcode_symbology", "brand_id", "category_id",
         "unit_id", "purchase_unit_id", "sale_unit_id", "cost", "price", "qty",
          "alert_quantity", "promotion", "promotion_price", "starting_date", 
          "last_date", "tax_id", "tax_method", "image", "file", "is_variant",
           "featured", "product_list", "qty_list", "price_list", "product_details", 
           "is_active","mano_obra","tiempo_produccion","producto_derivado"
    ];
