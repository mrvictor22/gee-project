                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input hidden name="estado_tick_hidden" value="<?php echo e($idventa); ?>" />
                                            <select name="estado_tick" class="form-control">
...
$('select[name="estado_tick"]').val($('input[name="estado_tick_hidden"]').val());
