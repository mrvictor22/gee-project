        ...
        <table id="biller-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($biller->id); ?>">
                    ...
                    <td><?php echo e($biller->correlativo_actual); ?></td>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    ...
                                    <a href="<?php echo e(route('biller.invoice', ['id' => $biller->id])); ?>" class="btn btn-link"><i class="dripicons-article"></i> Corte Z del día</a> 
                                </li>
                                <?php endif; ?>
                                <?php if(in_array("billers-edit", $all_permission)): ?>
                                <li>
                                
                                    <a href="<?php echo e(route('biller.invoicecortezmes', ['id' => $biller->id])); ?>" class="btn btn-link"><i class="dripicons-article"></i> Corte Z del mes</a> 
                                </li>
                                <?php endif; ?>
                                <?php if(in_array("billers-edit", $all_permission)): ?>
                                <li>
                                
                                    <a href="<?php echo e(route('biller.invoicetiraje', ['id' => $biller->id])); ?>" class="btn btn-link"><i class="dripicons-article"></i>Tickets del dia</a> 
                                </li>
                                <?php endif; ?>
                                <li class="divider"></li>
