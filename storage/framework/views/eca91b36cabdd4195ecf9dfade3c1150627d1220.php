        ...
        <div class="side-navbar-wrapper">
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              ?>
              <?php if($index_permission_active): ?>
              <li><a href="#produccion" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document"></i><span><?php echo e(trans('file.Produccion')); ?></span><span></a>
                <ul id="produccion" class="collapse list-unstyled ">
                  ...
                  ?>
                  <?php if($add_permission_active): ?>
                  <li id="lineaproduccion-menu"><a href="<?php echo e(route('lineaproduccion.index')); ?>"><?php echo e(trans('file.Linea de Produccion')); ?></a></li>
                  <?php endif; ?>
    ...
    <div class="page">
      ...
      <footer hidden class="main-footer">
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-12">
              <p>&copy; <?php echo e($general_setting->site_title); ?> | <?php echo e(trans('file.Developed')); ?> <?php echo e(trans('file.By')); ?> <a href="http://jbdevelopmentsv.com/" class="external">JB Development</a></p>
            </div>
          </div>
        </div>
      </footer>
