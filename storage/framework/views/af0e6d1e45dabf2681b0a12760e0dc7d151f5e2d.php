...
<section>
    <div class="container-fluid">
        <?php if(in_array("quotes-add", $all_permission)): ?>
            <a href="<?php echo e(route('lecherecibida.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(trans('file.Agregar')); ?></a>
        <?php endif; ?>
    </div>
        ...
        <table id="quotation-table" class="table quotation-list">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.Cantidad')); ?></th>
            ...
            <tbody>
                ...
                ?>
                <tr class="quotation-link" data-quotation='["<?php echo e(date($general_setting->date_format, strtotime($quotation->created_at->toDateString()))); ?>", "<?php echo e($quotation->qty); ?>]'>
                    ...
                    <td>N/A</td>
                    <?php endif; ?>                    
                    <td><?php echo e($quotation->qty); ?></td>
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a class="btn btn-link" href="<?php echo e(route('lecherecibida.edit', ['id' => $quotation->id])); ?>"><i class="dripicons-document-edit"></i> <?php echo e(trans('file.edit')); ?></a></button> 
                                </li>
                                <?php endif; ?>
                                ...
                                <?php echo e(Form::open(['route' => ['lecherecibida.destroy', $quotation->id], 'method' => 'DELETE'] )); ?>
