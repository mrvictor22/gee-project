                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select name="type" required class="form-control selectpicker" id="type">
                                                <option value="standard">Producto para venta</option>
                                                <option value="combo">Producto Combo</option>
                                ...
                                <div class="col-md-4">
                                 ...
                                 <!-- Este es el campo de mano de obra -->
                              <!--div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        <label><?php echo e(trans('file.Mano Obra')); ?> *</strong> </label>
                                        <input type="number" min="0" name="mano_obra" value="<?php echo e($lims_product_data->mano_obra); ?>" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div-->

                              <!-- Este es el campo de tiempo de produccion -->
                              <!-- <div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        <label><?php echo e(trans('file.Tiempo Preparacion')); ?> *</strong> </label>
                                        <input type="number" min="0" name="tiempo_produccion" value="<?php echo e($lims_product_data->tiempo_produccion); ?>" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div> -->
                                ...
                                <!-- <div class="form-group">
                                            <label><?php echo e('Producto derivado'); ?> </label>
                                            
                                            <select  name="producto_derivado" id="producto_derivado" class="selectpicker form-control" data-live-search="true"  title="Seleccione producto">
                                           
                                           <?php $__currentLoopData = $lims_product_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          
                                                <option value="<?php echo e($producto->name); ?>"><?php echo e(($producto->name)); ?>(<?php echo e($producto->code); ?>)</option>
                                        ...
                                        <!-- <div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        <label><?php echo e(trans('Cantidad de sobrante - Solo para productos del tipo sobrante')); ?></strong> </label>
                                        <input type="number" min="0" name="qty" value="<?php echo e($lims_product_data->qty); ?>"  class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>  -->
...
<script type="text/javascript">
    ...
    /*$('select[name="producto_derivado"]').val($('input[name="producto_derivado_hidden"]').val());*/
    $("#digital").hide();
    $("#combo").hide();
