                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select name="type" required class="form-control selectpicker" id="type">
                                                <option value="standard">Materia Prima o Producto para venta</option>
                                                <option value="combo">Receta Producto</option>
                              ...
                              <div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        <label><?php echo e(trans('Mano Obra (Personas)')); ?> *</strong> </label>
                                        <input type="number" min="0" name="mano_obra" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                              ...
                              <div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        ...
                                        <input type="number" min="0" name="tiempo_produccion" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                               
                                <div class="form-group">
                                            <label><?php echo e(trans('Producto derivado')); ?> </label>
                                           ...
                                           <?php $__currentLoopData = $lims_product_lista; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $producto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="number" min="0" name="qty"  class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>-->
...
<script type="text/javascript">
    ...
    <?php $productArray = []; ?>
    var lims_product_code = [ <?php $__currentLoopData = $lims_product_list2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
