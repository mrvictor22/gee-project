...
Route::group(['middleware' => ['auth', 'active']], function() {
	...
	Route::get('biller/gen_invoice/{id}', 'BillerController@invoice')->name('biller.invoice');
	Route::get('biller/gen_invoicemes/{id}', 'BillerController@invoicemes')->name('biller.invoicecortezmes');
	Route::get('biller/gen_tiraje/{id}', 'BillerController@tiraje')->name('biller.invoicetiraje');
	...
	Route::get('sales/gen_invoicecf/{id}', 'SaleController@genInvoicecf')->name('sale.invoicecf');
	Route::get('sales/gen_invoicefactura/{id}', 'SaleController@genInvoicefactura')->name('sale.invoicefactura');
	Route::get('sales/gen_invoiceticketh/{id}', 'SaleController@genInvoicetickh')->name('sale.invoiceticketh');
	...
	Route::resource('lecherecibida', 'LecherecibidaController');
	Route::resource('lineaproduccion', 'LineaproduccionController');
	Route::post('lineaproduccion/deletebyselection', 'LineaproduccionController@deleteBySelection');	
	Route::get('lineaproduccion/lims_product_search', 'LineaproduccionController@limsProductSearch')->name('lineaproduccion.search');
	
	
	Route::resource('procesos', 'Procesos');
	Route::resource('reprocesos', 'ReprocesosController');
	...
	Route::post('report/product_prod_cost', 'ReportController@productprodCost')->name('report.product_prod_cost');
