...
return [
	...
	"Leche Recibida" => "Milk Received",
	"Linea de Produccion" => "Production line",
	"Procesos" => "Processes",
	"Reprocesos" => "Reprocesses",
	"Reportes" => "Production Report",
	"Agregar" => "Add",
	"Cantidad" => "Quantity (Liters)",
	"Fecha Ingreso" => "Received date",
	"Leche por ingresar" => "Milk to receive",
];
?>