...
<section>
    <div class="container-fluid">
        ...
        @if(in_array("quotes-add", $all_permission))
            <a href="{{route('reprocesos.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('file.Agregar')}}</a>
        @endif
    </div>
            ...
            <tbody>
                ...
                <?php
                    ...
                    elseif($quotation->status == 'Terminado')
                        $status = trans('Reproceso terminado');
                ...
                <tr class="quotation-link" data-quotation='["{{date($general_setting->date_format, strtotime($quotation->created_at->toDateString()))}}", "{{$quotation->nombre_producto}}]'>
                    ...
                    <td>{{$quotation->codigo_producto}}</td>
                    <td>{{ $quotation->total_lb_reproceso}}</td>
                    @if($quotation->status == 'En espera')
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a class="btn btn-link" href="{{ route('reprocesos.edit', ['id' => $quotation->id]) }}"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</a></button> 
                                </li>
                                @endif
                                ...
                                {{ Form::open(['route' => ['reprocesos.destroy', $quotation->id], 'method' => 'DELETE'] ) }}
                                <li>
