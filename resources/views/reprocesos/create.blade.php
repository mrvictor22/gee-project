            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        ...
                        <h4>{{'Entrada de producto a reprocesos'}}</h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        {!! Form::open(['route' => 'reprocesos.store', 'method' => 'post', 'files' => true, 'id' => 'quotation-form']) !!}
                        ...
                        <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="total_lb_reproceso" class="form-control" step="any" required>
                                        </div>
                                    </div>        
