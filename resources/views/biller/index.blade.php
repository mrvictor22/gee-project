        ...
        <table id="biller-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="{{$biller->id}}">
                    ...
                    <td>{{ $biller->correlativo_actual}}</td>
                    <td>{{ $biller->email}}</td>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    ...
                                    <a href="{{ route('biller.invoice', ['id' => $biller->id]) }}" class="btn btn-link"><i class="dripicons-article"></i> Corte Z del día</a> 
                                </li>
                                @endif
                                @if(in_array("billers-edit", $all_permission))
                                <li>
                                
                                    <a href="{{ route('biller.invoicecortezmes', ['id' => $biller->id]) }}" class="btn btn-link"><i class="dripicons-article"></i> Corte Z del mes</a> 
                                </li>
                                @endif
                                @if(in_array("billers-edit", $all_permission))
                                <li>
                                
                                    <a href="{{ route('biller.invoicetiraje', ['id' => $biller->id]) }}" class="btn btn-link"><i class="dripicons-article"></i>Tickets del dia</a> 
                                </li>
                                @endif
                                <li class="divider"></li>
