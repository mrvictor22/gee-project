                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                              ...
                              <!--div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        <label>{{trans('file.Mano Obra')}} *</strong> </label>
                                        <input type="number" min="0" name="mano_obra" value="{{$lims_product_data->mano_obra}}" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div-->
                              ...
                              <!-- <div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        <label>{{trans('file.Tiempo Preparacion')}} *</strong> </label>
                                        <input type="number" min="0" name="tiempo_produccion" value="{{$lims_product_data->tiempo_produccion}}" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div> -->
                                ...
                                <!-- <div class="form-group">
                                           ...
                                           @foreach($lims_product_list as $producto)
                                                ...
                                                <option value="{{$producto->name}}">{{($producto->name)}}({{$producto->code}})</option>
                                        ...
                                        <!-- <div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        <label>{{trans('Cantidad de sobrante - Solo para productos del tipo sobrante')}}</strong> </label>
                                        <input type="number" min="0" name="qty" value="{{$lims_product_data->qty}}"  class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>  -->
