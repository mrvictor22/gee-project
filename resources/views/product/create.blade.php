                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            <div class="row">
                              ...
                              <!--div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        <label>{{trans('Mano Obra (Personas)')}} *</strong> </label>
                              ...
                              <!--div id="cost" class="col-md-4">
                                ...
                                <!--div class="form-group">
                                            <label>{{trans('Producto derivado')}} </label>
                                           ...
                                           @foreach($lims_product_lista as $producto)
...
<script type="text/javascript">
    ...
    <?php $productArray = []; ?>
    var lims_product_code = [ @foreach($lims_product_list2 as $product)
        <?php
