...
<section>
    <div class="container-fluid">
        @if(in_array("quotes-add", $all_permission))
            <a href="{{route('lecherecibida.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('file.Agregar')}}</a>
        @endif
    </div>
    <div class="table-responsive">
        <table id="quotation-table" class="table quotation-list">
            ...
            <tbody>
                ...
                ?>
                <tr class="quotation-link" data-quotation='["{{date($general_setting->date_format, strtotime($quotation->created_at->toDateString()))}}", "{{$quotation->qty}}]'>
                    <td>{{$key}}</td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a class="btn btn-link" href="{{ route('lecherecibida.edit', ['id' => $quotation->id]) }}"><i class="dripicons-document-edit"></i> {{trans('file.edit')}}</a></button> 
                                </li>
                                @endif
                                ...
                                {{ Form::open(['route' => ['lecherecibida.destroy', $quotation->id], 'method' => 'DELETE'] ) }}
                                <li>
