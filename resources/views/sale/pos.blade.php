...
<section class="forms pos-section">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body" style="padding-bottom: 0">
                     <!--APERTURA DEL FORM DE STORE POST-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                        <select required  name="doc_f" class="selectpicker form-control" data-live-search="true" title="Seleccione documento">
            ...
            <!--CERRADO DEL FORM DE STORE POST-->
            {!! Form::close() !!}
            <!-- product list -->
            <div class="col-md-6">
                <!-- navbar-->
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="city" required class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="a_favor" class="form-control">
                                </div>
...
$("#myTable").on('click', '.plus', function() {
    ...
    var qty = parseFloat($('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ') .qty').val()) + 0.25;
    qty = qty.toFixed(2)
...
$("#myTable").on('input', '.qty', function() {
    rowindex = $(this).closest('tr').index();
    if($(this).val() < 0.01 && $(this).val() != '') {
      $('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ') .qty').val(0.25);
