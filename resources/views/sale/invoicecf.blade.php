...
<div id="receipt-data">
        ...
        <!--tr>
            ...
            <td>H1</td>
                ...
                <tr>
               <!-- <td></td> -->
                <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$lims_customer_data->name}}</td>
                
                <td colspan="3" style="text-align:left;">{{$lims_sale_data->created_at->format('d-m-Y') }}</td>
               
                </tr>

                <tr >
             <!--   <td></td>-->
                <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$lims_customer_data->address}}</td>
                <td  colspan="3" style="text-align:left;">&nbsp;{{$lims_customer_data->registro}}</td> <!--registro-->
               <!-- <td></td> -->
                </tr>

                <tr >
              <!--  <td></td>-->
                <td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$lims_customer_data->city}}</td> <!--Municipio / Departamento-->
                <td  colspan="3" style="text-align:left;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$lims_customer_data->nit}}</td><!--NIT-->
               <!-- <td></td> -->
                </tr>
             ...
             <!--   <td></td>-->
                ...
                <td colspan="3" style="text-align:left;">{{$lims_customer_data->giro}}</td>
                </tr>
        ...
        <tr style="min-height:30px; max-height:30px; height:30px;">
            ...
            <!-- <td></td> -->
                ...
                <tr>
               <!-- <td></td>-->
                <td width="35px" class="centered">&nbsp;{{$product_sale_data->qty}}</td>
                
                <td width="180px"> &nbsp;&nbsp;&nbsp;{{$product_name}}</td>
                <td width="45px">@php 
                $dato_iva= 1.13;
                $sacandoiva = $product_sale_data->net_unit_price / $dato_iva;
                echo number_format($sacandoiva, 2, '.', '') ;
                                     
                @endphp </td> <!--number_format((float)($product_sale_data->total / $product_sale_data->qty), 2, '.', '')-->
               ...
               $vn[] = $ventasafectas;
                ...
                <td width="180px"> &nbsp;&nbsp;&nbsp; {{trans('file.Shipping Cost')}}</td>
                <td width="45px">{{number_format((float)$lims_sale_data->shipping_cost / 1.13, 2, '.', '')}} </td>
                <td width="45px">&nbsp;</td><!--Ventas <br>No sujetas-->
                <td width="45px">&nbsp;</td><!--Ventas <br>Exentas-->
                <td width="45px">{{number_format((float)$lims_sale_data->shipping_cost / 1.13, 2, '.', '')}}</td>
                </tr>
               ...
               /* echo $alto_fila;*/
                ...
                <td style="text-align:right;">{{number_format((float)($ivasubtotal2), 2, '.', '')}}</td>
                <td></td>
                </tr>
